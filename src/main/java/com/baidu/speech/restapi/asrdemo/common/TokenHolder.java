package com.baidu.speech.restapi.asrdemo.common;
...
public class TokenHolder {
    ...
    public void resfresh() throws IOException, DemoException {
        String getTokenURL = url + "?grant_type=client_credentials"
                + "&client_id=" + com.baidu.speech.restapi.common.ConnUtil.urlEncode(apiKey) + "&client_secret=" + com.baidu.speech.restapi.common.ConnUtil.urlEncode(secretKey);
