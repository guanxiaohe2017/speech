...
//    private final String APP_KEY = "kVcnfD9iW2XVZSMaLMrtLYIz";
    // my
    private final String APP_KEY = "uZDznAGiWG9bXTrvQ80E7l9W";

    // 填写网页上申请的APP SECRET 如 $SECRET_KEY="94dc99566550d87f8fa8ece112xxxxx"
//    private final String SECRET_KEY = "O9o1O213UgG5LFn0bDGNtoRN3VWl2du6";
    // my
    private final String SECRET_KEY = "WmmsV9tRkHZxX2FxLe0czny69EePCEoI";
...
//        System.out.println(result);
        byte[] bytes = new AsrMain().getFileContent("16k.m4a");

        String result = AsrUtil.obtainAsrResult(bytes);
        System.out.println(result);
